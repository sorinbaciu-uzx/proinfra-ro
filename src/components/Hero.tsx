...
export function Hero({ title, highlight, description }: HeroProps) {
  return (
    <section className="hero-section bg-gradient-to-br from-[#0a1628] to-[#1e3a5f] text-white py-24 md:py-28">
